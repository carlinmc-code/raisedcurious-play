...
const Kit = {
  ...
  /* ---------- the finger guide ----------
     Same idea as assets/toy.js?v=164767d5580e our player cannot read, so the tutorial is a
  ...
  loadMatter(){
    return new Promise((res, rej) => {
      ...
      s.src = '../shared/matter.min.js?v=164767d5580e';
...
const Sound = {
  ...
  /* See assets/toy.js?v=164767d5580e for the full reasoning. Short version: WebKit (which is
  ...
  ready(){
    ...
    this.unlock();
    // See assets/toy.js?v=164767d5580e keep the first tap audible, but bounded so a stuck
...
if ('serviceWorker' in navigator && location.protocol.indexOf('http') === 0)
  navigator.serviceWorker.register('/sw.js?v=164767d5580e').catch(function(){});
